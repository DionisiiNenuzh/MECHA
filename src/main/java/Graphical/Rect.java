...
public class Rect {
    ...
    public void draw(GraphicsEngine graphicsEngine, Vector2 move) {
        ...
        for (int i = 1; i < 4; i += 1) {
            graphicsEngine.drawLine(points.get(i - 1), points.get(i));
        }
        // the last line added
        graphicsEngine.drawLine(points.get(0), points.get(3));
...
//                graphicsEngine.setStroke(new BasicStroke(5));
                graphicsEngine.setColor(Color.red);
                // draws a line containing one point
                graphicsEngine.drawLine(new Vector2(xPos, yPos), new Vector2(xPos, yPos));
            }
        }
    ...
    public String toString() {
        ...
        String answer = String.valueOf((int) this.getPosition().getX());
        answer += " " + (int) this.getPosition().getY();
        answer += " " + this.getWidth() + " " + this.getHeight();
        if (this.getMass() != 0f) {
            answer += " " + this.getMass();
        }
        answer += " " + this.getId();
